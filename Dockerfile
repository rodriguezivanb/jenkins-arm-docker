...
RUN apt-get update && \
    apt-get install -y openjdk-11-jdk git curl gpg unzip libfreetype6 libfontconfig1 && \
...
ARG JENKINS_URL=https://get.jenkins.io/war-stable/2.319.1/jenkins.war
